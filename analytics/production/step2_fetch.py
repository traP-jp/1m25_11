...
try:
    ...
    with open('traQ_data.json', 'w', encoding='utf-8') as f:
        json.dump(all_traQ_data, f, ensure_ascii=False, indent=2)
    with open('traQing_data.json', 'w', encoding='utf-8') as f:
        json.dump(all_traQing_data, f, ensure_ascii=False, indent=2)
